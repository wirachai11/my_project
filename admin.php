        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="img/jack.jpg" alt="" style="width: 40px; height: 40px;">
                            <span class="d-none d-lg-inline-flex">jack</span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <?php 
                                     $sql = "SELECT COUNT(*) as users FROM admin_login";
                                     $query = $conn->prepare($sql);
                                     $query->execute();
                                     $fetch = $query->fetch();
                                ?>
                                <h6 class="mb-0"><?=$fetch['users'] ?></h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <?php
                                // สร้างคำสั่ง SQL เพื่อดึงข้อมูลล่าสุด
                                //require_once"config/db.php";
                                ...
                                ?>
                                <h6 class="mb-0"><?php echo"".$row[humidity];?></h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
            ...
            <div class="container-fluid pt-4 px-4">
            <form action="updateOn.php" method="post">
            <div>
            <input  class="btn btn-outline-danger m-2"type="submit" name="updateOn" value="On">
            </div>

            </form>
            <form action="updateOff.php" method="post">
            <div>
            <input  class="btn btn-outline-dark m-2"type="submit" name="updateOff" value="Off">
            </form>
            </div>
            </div>
